                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid rounded-3xl gap-3 p-4 md:w-[400px] lg:w-[500px] xl:w-[550px] lg:grid-cols-[.75fr_1fr]">
                            ...
                            <Item title="Análise de Dados" href="/features/content-calendar" icon={<CalendarRangeIcon className="w-5 h-5" />}>
                                Análise detalhada dos seus dados empresariais.
                            </Item>
                            <Item title="Desenvolvimento de Agentes" href="/features/hashtag-manager" icon={<HashIcon className="w-5 h-5" />}>
                                Criação de agentes de IA personalizados.
                            </Item>
                            <Item title="Integração de Sistemas" href="/features/competitor-analysis" icon={<UsersIcon className="w-5 h-5" />}>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[400px] md:grid-cols-2 lg:w-[500px] xl:w-[500px]">
                            <Item title="Blog" href="/resources/blog" icon={<Newspaper className="w-5 h-5" />}>
                                Leia nossos artigos e atualizações mais recentes.
                            </Item>
                            <Item title="Suporte" href="/resources/support" icon={<CircleHelp className="w-5 h-5" />}>
                                Obtenha ajuda com qualquer problema que você possa ter.
                            </Item>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
